    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('state', models.CharField(max_length=50, verbose_name=(('jadibutti', 'jadibutti'), ('koteshwor', 'koteshwor'), ('lokanthali', 'lokanthali'), ('baneshwor', 'baneshwor'), ('ratnapark', 'ratnapark'), ('kandaghari', 'kandaghari'), ('thimi', 'thimi'), ('bagbazar', 'bagbazar'), ('chabahil', 'chabahil'), ('airport', 'airport'), ('pepsi', 'pepsi')))),
